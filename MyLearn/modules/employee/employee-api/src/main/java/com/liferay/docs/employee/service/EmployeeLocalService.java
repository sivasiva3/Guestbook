...
public interface EmployeeLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.docs.employee.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employee local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeeLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Employee addEmployee(
			...
			String role, long salary, Date joinedDate, ServiceContext service)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Employee> getEmployees(long groupId, long employeeId,int start,int end)
		throws PortalException;
	...
	public Employee updateEmployee(
			...
			long salary, Date joinedDate, ServiceContext service)
		throws PortalException;
