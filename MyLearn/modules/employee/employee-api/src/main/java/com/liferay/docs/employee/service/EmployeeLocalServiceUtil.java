 ...
 * <code>com.liferay.docs.employee.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.docs.employee.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Employee> getEmployees(long groupId, long employeeId,int start,int end)
		throws PortalException {

		return getService().getEmployees(groupId, employeeId,start,end);
	}
	...
	public static long getEmployeesCount(long groupId) {
