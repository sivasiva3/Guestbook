...
import com.liferay.docs.employee.model.EmployeeTable;
...
import com.liferay.docs.employee.service.persistence.EmployeeUtil;
import com.liferay.docs.employee.service.persistence.impl.constants.EBPersistenceConstants;
...
public class EmployeePersistenceImpl
	 ...
	 */
	@Override
	public List<Employee> findByG_N_D(
		long groupId, String name, String department) {

		return findByG_N_D(
			groupId, name, department, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	...
	public List<Employee> findByG_N_D(
		...
		return findByG_N_D(groupId, name, department, start, end, null);
	}
	...
	public List<Employee> findByG_N_D(
		...
		return findByG_N_D(
			groupId, name, department, start, end, orderByComparator, true);
	}
	...
	public List<Employee> findByG_N_D(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {groupId, name, department};
			}
		}
		else if (useFinderCache) {
		...
		if (list == null) {
			...
			if (department.isEmpty()) {
				sb.append(_FINDER_COLUMN_G_N_D_DEPARTMENT_3);
			}
			else {
				bindDepartment = true;

				sb.append(_FINDER_COLUMN_G_N_D_DEPARTMENT_2);
			}
	...
	public Employee findByG_N_D_First(
		...
		Employee employee = fetchByG_N_D_First(
	...
	public Employee fetchByG_N_D_First(
		...
		List<Employee> list = findByG_N_D(
			groupId, name, department, 0, 1, orderByComparator);
	...
	public Employee findByG_N_D_Last(
		...
		Employee employee = fetchByG_N_D_Last(
			groupId, name, department, orderByComparator);
	...
	public Employee fetchByG_N_D_Last(
		...
		int count = countByG_N_D(groupId, name, department);
		...
		List<Employee> list = findByG_N_D(
			groupId, name, department, count - 1, count, orderByComparator);
	...
	public Employee[] findByG_N_D_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_N_D_PrevAndNext(
				session, employee, groupId, name, department, orderByComparator,
				true);
	...
	protected Employee getByG_N_D_PrevAndNext(
		Session session, Employee employee, long groupId, String name,
		String department, OrderByComparator<Employee> orderByComparator,
		boolean previous) {
	...
	public void removeByG_N_D(long groupId, String name, String department) {
		for (Employee employee :
				findByG_N_D(
					groupId, name, department, QueryUtil.ALL_POS,
	...
	public int countByG_N_D(long groupId, String name, String department) {
		...
		Object[] finderArgs = new Object[] {groupId, name, department};
	...
	private static final String _FINDER_COLUMN_G_N_D_DEPARTMENT_2 =
		"employee.department = ?";

	private static final String _FINDER_COLUMN_G_N_D_DEPARTMENT_3 =
		"(employee.department IS NULL OR employee.department = '')";
	 ...
	 */
	@Override
	public List<Employee> findByG_N(long groupId, String name) {
		return findByG_N(
	 ...
	 */
	@Override
	public List<Employee> findByG_N(
	...
	public Employee findByG_N_First(
		...
		Employee employee = fetchByG_N_First(groupId, name, orderByComparator);
	...
	public Employee fetchByG_N_First(
		...
		List<Employee> list = findByG_N(groupId, name, 0, 1, orderByComparator);
	...
	public Employee findByG_N_Last(
		...
		Employee employee = fetchByG_N_Last(groupId, name, orderByComparator);
	...
	public Employee[] findByG_N_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_N_PrevAndNext(
				session, employee, groupId, name, orderByComparator, true);

			array[1] = employee;

			array[2] = getByG_N_PrevAndNext(
				session, employee, groupId, name, orderByComparator, false);
	...
	protected Employee getByG_N_PrevAndNext(
		Session session, Employee employee, long groupId, String name,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_G_N_NAME_2 = "employee.name = ?";
	 ...
	 */
	@Override
	public List<Employee> findByG_E(long groupId, long employeeId) {
		return findByG_E(
	 ...
	 */
	@Override
	public List<Employee> findByG_E(
		long groupId, long employeeId, int start, int end) {

		return findByG_E(groupId, employeeId, start, end, null);
	}
	...
	public List<Employee> findByG_E(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_E_EMPLOYEEID_2);
	...
	public Employee findByG_E_First(
		...
		Employee employee = fetchByG_E_First(
	...
	public Employee findByG_E_Last(
		...
		Employee employee = fetchByG_E_Last(
			groupId, employeeId, orderByComparator);
	...
	public Employee fetchByG_E_Last(
		...
		int count = countByG_E(groupId, employeeId);
	...
	private static final String _FINDER_COLUMN_G_E_EMPLOYEEID_2 =
		"employee.employeeId = ?";

	private FinderPath _finderPathWithPaginationFindByG_D_R;
	private FinderPath _finderPathWithoutPaginationFindByG_D_R;
	private FinderPath _finderPathCountByG_D_R;
	 ...
	 */
	@Override
	public List<Employee> findByG_D_R(
		long groupId, String role, String department) {

		return findByG_D_R(
			groupId, role, department, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	...
	public List<Employee> findByG_D_R(
		...
		return findByG_D_R(groupId, role, department, start, end, null);
	}
	...
	public List<Employee> findByG_D_R(
		...
		return findByG_D_R(
			groupId, role, department, start, end, orderByComparator, true);
	}
	...
	public List<Employee> findByG_D_R(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByG_D_R;
				finderArgs = new Object[] {groupId, role, department};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByG_D_R;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_D_R_GROUPID_2);

			boolean bindRole = false;

			if (role.isEmpty()) {
				sb.append(_FINDER_COLUMN_G_D_R_ROLE_3);
			}
			else {
				bindRole = true;

				sb.append(_FINDER_COLUMN_G_D_R_ROLE_2);
			}

			boolean bindDepartment = false;

			if (department.isEmpty()) {
				sb.append(_FINDER_COLUMN_G_D_R_DEPARTMENT_3);
			}
			else {
				bindDepartment = true;

				sb.append(_FINDER_COLUMN_G_D_R_DEPARTMENT_2);
			}
	...
	public Employee findByG_D_R_First(
		...
		Employee employee = fetchByG_D_R_First(
	...
	public Employee fetchByG_D_R_First(
		...
		List<Employee> list = findByG_D_R(
			groupId, role, department, 0, 1, orderByComparator);
	...
	public Employee findByG_D_R_Last(
		...
		Employee employee = fetchByG_D_R_Last(
			groupId, role, department, orderByComparator);
	...
	public Employee fetchByG_D_R_Last(
		...
		int count = countByG_D_R(groupId, role, department);
		...
		List<Employee> list = findByG_D_R(
			groupId, role, department, count - 1, count, orderByComparator);
	...
	public Employee[] findByG_D_R_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_D_R_PrevAndNext(
				session, employee, groupId, role, department, orderByComparator,
				true);

			array[1] = employee;

			array[2] = getByG_D_R_PrevAndNext(
				session, employee, groupId, role, department, orderByComparator,
				false);
	...
	protected Employee getByG_D_R_PrevAndNext(
		Session session, Employee employee, long groupId, String role,
		String department, OrderByComparator<Employee> orderByComparator,
		boolean previous) {
	...
	public void removeByG_D_R(long groupId, String role, String department) {
		for (Employee employee :
				findByG_D_R(
					groupId, role, department, QueryUtil.ALL_POS,
					QueryUtil.ALL_POS, null)) {
	...
	public int countByG_D_R(long groupId, String role, String department) {
		...
		FinderPath finderPath = _finderPathCountByG_D_R;

		Object[] finderArgs = new Object[] {groupId, role, department};
	...
	private static final String _FINDER_COLUMN_G_D_R_GROUPID_2 =
		"employee.groupId = ? AND ";

	private static final String _FINDER_COLUMN_G_D_R_ROLE_2 =
		"employee.role = ? AND ";

	private static final String _FINDER_COLUMN_G_D_R_ROLE_3 =
		"(employee.role IS NULL OR employee.role = '') AND ";

	private static final String _FINDER_COLUMN_G_D_R_DEPARTMENT_2 =
		"employee.department = ?";

	private static final String _FINDER_COLUMN_G_D_R_DEPARTMENT_3 =
		"(employee.department IS NULL OR employee.department = '')";
	 ...
	 */
	@Override
	public List<Employee> findByG_D(long groupId, String department) {
		return findByG_D(
	 ...
	 */
	@Override
	public List<Employee> findByG_D(
		long groupId, String department, int start, int end) {

		return findByG_D(groupId, department, start, end, null);
	}
	...
	public List<Employee> findByG_D(
		...
		if (list == null) {
			...
			if (department.isEmpty()) {
				sb.append(_FINDER_COLUMN_G_D_DEPARTMENT_3);
			}
			else {
				bindDepartment = true;

				sb.append(_FINDER_COLUMN_G_D_DEPARTMENT_2);
			}
	...
	public Employee findByG_D_First(
		...
		Employee employee = fetchByG_D_First(
	...
	public Employee findByG_D_Last(
		...
		Employee employee = fetchByG_D_Last(
			groupId, department, orderByComparator);
	...
	public Employee fetchByG_D_Last(
		...
		int count = countByG_D(groupId, department);
	...
	public Employee[] findByG_D_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_D_PrevAndNext(
				session, employee, groupId, department, orderByComparator,
				true);
	...
	protected Employee getByG_D_PrevAndNext(
		Session session, Employee employee, long groupId, String department,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_G_D_DEPARTMENT_2 =
		"employee.department = ?";

	private static final String _FINDER_COLUMN_G_D_DEPARTMENT_3 =
		"(employee.department IS NULL OR employee.department = '')";
	 ...
	 */
	@Override
	public List<Employee> findByG_R(long groupId, String role) {
		return findByG_R(
			groupId, role, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Employee> findByG_R(
		long groupId, String role, int start, int end) {

		return findByG_R(groupId, role, start, end, null);
	}
	...
	public List<Employee> findByG_R(
		...
		return findByG_R(groupId, role, start, end, orderByComparator, true);
	}
	...
	public List<Employee> findByG_R(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {groupId, role};
			}
		}
		else if (useFinderCache) {
		...
		if (list == null) {
			...
			if (role.isEmpty()) {
				sb.append(_FINDER_COLUMN_G_R_ROLE_3);
			}
			else {
				bindRole = true;

				sb.append(_FINDER_COLUMN_G_R_ROLE_2);
			}
	...
	public Employee findByG_R_First(
		...
		Employee employee = fetchByG_R_First(groupId, role, orderByComparator);
	...
	public Employee fetchByG_R_First(
		...
		List<Employee> list = findByG_R(groupId, role, 0, 1, orderByComparator);
	...
	public Employee findByG_R_Last(
		...
		Employee employee = fetchByG_R_Last(groupId, role, orderByComparator);
	...
	public Employee fetchByG_R_Last(
		...
		int count = countByG_R(groupId, role);

		if (count == 0) {
			return null;
		}

		List<Employee> list = findByG_R(
			groupId, role, count - 1, count, orderByComparator);
	...
	public Employee[] findByG_R_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_R_PrevAndNext(
				session, employee, groupId, role, orderByComparator, true);

			array[1] = employee;

			array[2] = getByG_R_PrevAndNext(
				session, employee, groupId, role, orderByComparator, false);
	...
	protected Employee getByG_R_PrevAndNext(
		Session session, Employee employee, long groupId, String role,
		OrderByComparator<Employee> orderByComparator, boolean previous) {
	...
	public void removeByG_R(long groupId, String role) {
		for (Employee employee :
				findByG_R(
					groupId, role, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	public int countByG_R(long groupId, String role) {
		...
		Object[] finderArgs = new Object[] {groupId, role};
	...
	private static final String _FINDER_COLUMN_G_R_ROLE_2 = "employee.role = ?";

	private static final String _FINDER_COLUMN_G_R_ROLE_3 =
		"(employee.role IS NULL OR employee.role = '')";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_N_D = new FinderPath(
			...
			new String[] {"groupId", "name", "department"}, true);
		...
		_finderPathCountByG_N_D = new FinderPath(
			...
			new String[] {"groupId", "name", "department"}, false);
		...
		_finderPathWithPaginationFindByG_D_R = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_D_R",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"groupId", "role_", "department"}, true);

		_finderPathWithoutPaginationFindByG_D_R = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_D_R",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			},
		...
		_finderPathCountByG_D_R = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_D_R",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			},
			new String[] {"groupId", "role_", "department"}, false);
		...
		_finderPathCountByG_R = new FinderPath(
			...
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"groupId", "role_"}, false);
	...
	@Override
	@Reference(
		target = EBPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = EBPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
