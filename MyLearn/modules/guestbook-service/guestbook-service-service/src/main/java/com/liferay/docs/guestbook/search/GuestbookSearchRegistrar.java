...
public class GuestbookSearchRegistrar {
	@Activate
	protected void activate(BundleContext bundle) {
		_serviceRegistration = modelSearchRegistrarHelper.register( 
				Guestbook.class,bundle,modelSearchDefinition ->{
	...
	@Reference(target="(indexer.class.name=com.liferay.docs.guestbook.Guestbook)")
