...
public class GuestbookWorkflowHandler extends BaseWorkflowHandler<Guestbook>{
	...
	public Guestbook updateStatus(int status, Map<String,Serializable> workflowContext)throws PortalException{
		...
		ServiceContext service=(ServiceContext) workflowContext.get("service");
//		System.out.println("Primary Key:"+resourcePrimKey);
		return _guestbookLocalService.updateStatus(userId,resourcePrimKey,status,service);
	}
	@Reference(unbind="-")
